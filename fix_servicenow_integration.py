#!/usr/bin/env python3
"""
Fix for Salesforce → ServiceNow Integration
This script updates the ServiceNow client in Salesforce backend to use correct API format
"""

servicenow_client_fixed = '''"""
...
print("=" * 70)
print("SERVICENOW INTEGRATION FIX")
print("=" * 70)
print()
print("✅ Fixed servicenow.py code generated")
print()
print("📋 Changes made:")
print("  1. Added authentication with ServiceNow (gets token)")
print("  2. Changed from JSON body to query parameters")
print("  3. Added proper response parsing")
print("  4. Fixed ticket number extraction")
print()
print("📄 To apply the fix:")
print()
print("1. Backup current file:")
print("   cp /home/pradeep1a/Network-apps/Salesforce/backend/app/servicenow.py \\")
print("      /home/pradeep1a/Network-apps/Salesforce/backend/app/servicenow.py.backup")
print()
print("2. Copy the fixed code (saved in fixed_servicenow.py)")
print()
print("3. Restart Salesforce backend:")
print("   docker restart salesforce-backend")
print()
print("4. Test the integration:")
print("   python3 create_sample_appointment.py")
print()
print("=" * 70)

# Write the fixed code to a file
with open('/home/pradeep1a/Network-apps/fixed_servicenow.py', 'w') as f:
    f.write(servicenow_client_fixed)

print("✅ Fixed code saved to: fixed_servicenow.py")
print()
